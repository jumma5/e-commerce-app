  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 h-96 w-96 rounded-full bg-gradient-to-br from-primary to-accent blur-3xl"
      />
      <motion.div
        animate={{
          scale: [1, 1.3, 1],
        ...
        className="absolute bottom-0 right-0 h-[32rem] w-[32rem] rounded-full bg-gradient-to-tl from-accent to-primary blur-3xl"
      />
      ...
      >
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          {t.auth.noAccount}{" "}
          <Link href="/signup" className="font-semibold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent hover:opacity-80">
            {t.auth.signup}
          </Link>
        </p>
      </motion.div>
